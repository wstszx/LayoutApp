...
public class PinchImageView1 extends androidx.appcompat.widget.AppCompatImageView {
    ////////////////////////////////配置参数////////////////////////////////
    ...
    public boolean canScrollHorizontally(int direction) {
        if (mPinchMode == PinchImageView1.PINCH_MODE_SCALE) {
            return true;
        }
    ...
    public interface OuterMatrixChangedListener {
         ...
         */
        void onOuterMatrixChanged(PinchImageView1 pinchImageView);
    }
    ...
    public PinchImageView1(Context context) {
        super(context);
        initView();
    }

    public PinchImageView1(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView();
    }

    public PinchImageView1(Context context, AttributeSet attrs, int defStyle) {
     ...
     * 在onTouchEvent末尾被执行.
     */
    private GestureDetector mGestureDetector = new GestureDetector(PinchImageView1.this.getContext(), new GestureDetector.SimpleOnGestureListener() {
        ...
        public void onLongPress(MotionEvent e) {
            ...
            if (mOnLongClickListener != null) {
                mOnLongClickListener.onLongClick(PinchImageView1.this);
            }
        }
        ...
        public boolean onSingleTapConfirmed(MotionEvent e) {
            ...
            if (mOnClickListener != null) {
                mOnClickListener.onClick(PinchImageView1.this);
            }
            return true;
        }
    });
