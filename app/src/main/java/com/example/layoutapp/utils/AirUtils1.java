...
public class AirUtils1 {
    ...
    public static Path getFJLifts2() {
        Path path = new Path();
    ...
    public static Path getFireCurtain2() {
        Path path = new Path();
    ...
    public static Path getFireCurtain3() {
        Path path = new Path();
    ...
    public static Path getHangarDoor2() {
        Path path = new Path();
    ...
    //起飞线2
    public static Path getTakeoffLine2() {
        Path path = new Path();
        path.moveTo(153650f, 0);
    ...
    //阻拦索2
    public static Path getInterceptionCable2() {
        Path path = new Path();
    ...
    //阻拦索3
    public static Path getInterceptionCable3() {
        Path path = new Path();
    ...
    //阻拦索4
    public static Path getInterceptionCable4() {
        Path path = new Path();
...
//    }
    //安全区
//    public static Path getSafeArea1() {
//        Path path = new Path();
