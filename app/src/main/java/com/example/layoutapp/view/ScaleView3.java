...
//            位移到开始或结束坐标位置
            if (isChecked) {
                matrix.postTranslate(planList.get(i).getCox() * currentScale, planList.get(i).getCoy() * currentScale);
//                matrix.postTranslate(planList.get(i).getCox() * currentScale + left, planList.get(i).getCoy() * currentScale + top);
            } else {
                matrix.postTranslate(planList.get(i).getPlancox() * currentScale, planList.get(i).getPlancoy() * currentScale);
