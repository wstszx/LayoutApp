...
public class ScaleView1 extends androidx.appcompat.widget.AppCompatImageView {
...
//    };
    ...
    public ScaleView1(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ScaleView1(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
